...
# --- Overrides for experiment: code_focused ---
out_dir = '/data/yaxin/pretrain_data_analysis/out/gpt2-medium-code_focused'
dataset = 'slimpajama-3b-code_focused'
wandb_run_name = 'code_focused'
